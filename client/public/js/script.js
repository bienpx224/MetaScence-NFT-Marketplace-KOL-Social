(function($) {
    ...
    $('.countdown').countdown('2021/4/30').on('update.countdown', function(event) {
  var $this = $(this).html(event.strftime(''
  	+ '<div class="counter-bg mb-4 mb-lg-0"><span class="counter">%w</span> <span class="label">week%!d</span></div> '
